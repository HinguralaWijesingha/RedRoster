...
<nav class="navbar navbar-expand-lg navbar-light  " style="padding-left:120px; padding-right:120px; padding-bottom:12px; padding-top:12px; background-color:#3e3e3e "><img src="images/gt.png"  alt=""/> <a class="navbar-brand" href="#"><!--Green Town Solutions&nbsp;--></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent1">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active"> <a class="nav-link" href="admin_home.php">Home <span class="sr-only">(current)</span></a> </li>
          <?PHP if($user_type=='admin') { ?>
          <li class="nav-item active"> <a class="nav-link" href="./com/admin.php">Complaints <span class="sr-only">(current)</span></a></li>
          <?PHP } ?>
        ...
        <?PHP if($sid=="") { ?>
          ...
          <?PHP } else { ?>
          <li class="nav-item active" style="text-align:right; color:#FFF"> Hi <?PHP echo $client_name; ?> | <a href="admin-account.php" style="color:#6daded; text-decoration:underline">My Account </a> &nbsp;| <a class=" " href="logout.php" style="color:#F00">   <span style="text-decoration:underline">Log out</span><span class="sr-only">(current)</span></a></li>
          <?PHP } ?>
          </ul>
